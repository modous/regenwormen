...
public class PreGameService {
    ...
    @Autowired
    public PreGameService(GameRepository gameRepo, PlayerRepository playerRepo){this.gameRepo = gameRepo; this.playerRepo = playerRepo;}
    ...
    public Game findGameByID(String id){
        ...
        if(game == null){throw new IllegalArgumentException("Game with id: "+ id+ " does not exist");}
        return game;
    }
